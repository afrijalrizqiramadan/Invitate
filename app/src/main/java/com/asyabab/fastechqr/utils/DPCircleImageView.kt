...
class DPCircleImageView : androidx.appcompat.widget.AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(
        ...
        val a = context.obtainStyledAttributes(
            attrs,
            R.styleable.DPCircleImageView, defStyle, 0
        )

        mBorderWidth = a.getDimensionPixelSize(
            R.styleable.DPCircleImageView_civ_border_width,
            DEFAULT_BORDER_WIDTH
        )
        mBorderColor = a.getColor(
            R.styleable.DPCircleImageView_civ_border_color,
            DEFAULT_BORDER_COLOR
        )
        mBorderOverlay = a.getBoolean(
            R.styleable.DPCircleImageView_civ_border_overlay,
            DEFAULT_BORDER_OVERLAY
        )
        mFillColor = a.getColor(
            R.styleable.DPCircleImageView_civ_fill_color,
            DEFAULT_FILL_COLOR
        )

        name = a.getString(R.styleable.DPCircleImageView_name)
        a.recycle()
