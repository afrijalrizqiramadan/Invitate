...
public class DPShimmerAdapter extends RecyclerView.Adapter<DPShimmerViewHolder> {
    ...
    @Override
    public DPShimmerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());

        DPShimmerViewHolder shimmerViewHolder = new DPShimmerViewHolder(inflater, parent, mLayoutReference);
    ...
    @Override
    public void onBindViewHolder(DPShimmerViewHolder holder, int position) {
        holder.bind();
    }
